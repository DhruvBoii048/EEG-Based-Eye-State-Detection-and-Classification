# -*- coding: utf-8 -*-
"""EyeState_Final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_jKyKugmCfD9LNyxX8EVZsn6NYrGYYxs
...
import os
for dirname, _, filenames in os.walk('/content/Eye_State/EEG Eye State.arff'):
...
data, meta = arff.loadarff('/content/Eye_State/EEG Eye State.arff')
...
mem_usage = memory_usage(train_model_knn)
print(f"Max memory usage: {max(mem_usage)} MB")
...
#def train_model():
#    xgb_model.fit(x_train, y_train)
#mem_usage = memory_usage(xgb_model)
#print(f"Max memory usage: {max(mem_usage)} MB")
